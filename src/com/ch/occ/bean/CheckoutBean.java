...
public class CheckoutBean
{
    ...
    public CheckoutBean(String[] line)
    {
        ...
        address2 = line[5];
        city = line[6];
        stateregion = getIntValue(line[7]);
        zipcode = line[8];
        phonenumber = line[9];
        namecard = line[10];
        cardtype = line[11];
        cardnumber = line[12];
        checkoutcvv = line[13];
        expiresmonth = getIntValue(line[14]);
        expiresyear =  line[15];
    }
     ...
     */
    public void setStateregion(int stateregion)
    {
    ...
    /**
     * @param checkoutcvv the checkoutcvv to set
     */
