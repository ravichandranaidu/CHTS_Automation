...
import com.ch.tbc.reports.TestCaseImageDetail;
            ...
            for (Iterator<String> iterator = keySet.iterator(); iterator.hasNext();)
            {
                ...
                for (Iterator<TestCaseImageDetail> iterator2 = list.iterator(); iterator2.hasNext();)
                {
                    ...
                    content = content + "<td>" + testCaseResult.getTestCaseName() + "</td><td>"
                            + testCaseResult.getHeight() + "</td><td>" 
                            + testCaseResult.getWidth() + "</td><td>"
                            + testCaseResult.getTop() + "</td><td>" 
                            + testCaseResult.getLeft() + "</td><td>"
                            + testCaseResult.getRight() + "</td><td>" 
                            + testCaseResult.getMarginright() + "</td><td>"
                            + testCaseResult.getMarginleft() + "</td><td>" 
                            + testCaseResult.getMargintop() + "</td><td>"
                            + testCaseResult.getMarginbottom() + "</td><td>" 
                            + testCaseResult.getBottom() + "</td><td>"
                            + testCaseResult.getFontSize() + "</td><td>" 
                            + testCaseResult.getColor() + "</td><td>"
